...
- (UICollectionViewLayoutAttributes*)layoutAttributesForSupplementaryViewOfKind:(NSString*)elementKind atIndexPath:(NSIndexPath*)indexPath {
    ...
    if ([UICollectionElementKindSectionHeader isEqualToString:elementKind]) {
        ...
        //头视图
        attri = [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:UICollectionElementKindSectionHeader
        ...
        //脚视图
        attri = [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:UICollectionElementKindSectionFooter
                                                                               withIndexPath:indexPath];
...
- (CGRect)itemFrameOfVHWaterFlow:(NSIndexPath*)indexPath {
    ...
    if (collectionW - [[self.rowWidths firstObject] floatValue] > w + self.edgeInsets.right) {
        ...
        x = [[self.rowWidths firstObject] floatValue] == self.edgeInsets.left ? self.edgeInsets.left
                                                                              : [[self.rowWidths firstObject] floatValue] + self.columnMargin;
        ...
        if ([[self.columnHeights firstObject] floatValue] == self.edgeInsets.top ||
            [[self.columnHeights firstObject] floatValue] == self.edgeInsets.top + headViewSize.height) {
...
- (CGRect)itemFrameOfHorizontalGridWaterFlow:(NSIndexPath*)indexPath {
    ...
    x = [self.rowWidths[destRow] doubleValue] == self.edgeInsets.left ? self.edgeInsets.left
                                                                      : [self.rowWidths[destRow] doubleValue] + self.columnMargin;
    //更新最短那行的宽度
