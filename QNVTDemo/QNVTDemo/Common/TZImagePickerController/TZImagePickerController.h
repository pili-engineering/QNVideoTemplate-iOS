...
#pragma mark -
@property(nonatomic, strong) QNVTPropertyModel* userInfo;
...
/// If the user does not select any pictures, the current picture is automatically selected when the Finish button is clicked,
/// Default is YES 如果用户未选择任何图片，在点击完成按钮时自动选中当前图片，默认YES
...
/// Default is NO, if set YES, when selected photos's count up to maxImagesCount, other photo will show float layer what's color is
/// cannotSelectLayerColor. 默认是NO，如果设置为YES，当照片选择张数达到maxImagesCount时，其它照片会显示颜色为cannotSelectLayerColor的浮层
...
@property(nonatomic, copy) void (^photoPickerPageUIConfigBlock)(UICollectionView* collectionView,
                                                                ...
                                                                UILabel* numberLabel,
                                                                UIView* divideLine);
@property(nonatomic, copy) void (^photoPreviewPageUIConfigBlock)(UICollectionView* collectionView,
                                                                 UIView* naviBar,
                                                                 UIButton* backButton,
...
@property(nonatomic, copy) void (^assetCellDidSetModelBlock)(TZAssetCell* cell,
...
@property(nonatomic, copy) void (^photoPickerPageDidLayoutSubviewsBlock)(UICollectionView* collectionView,
                                                                         UIView* bottomToolBar,
                                                                         UIButton* previewButton,
                                                                         UIButton* originalPhotoButton,
                                                                         UILabel* originalPhotoLabel,
                                                                         ...
                                                                         UILabel* numberLabel,
                                                                         UIView* divideLine);
@property(nonatomic, copy) void (^photoPreviewPageDidLayoutSubviewsBlock)(UICollectionView* collectionView,
                                                                          UIView* naviBar,
                                                                          UIButton* backButton,
                                                                          UIButton* selectButton,
                                                                          UILabel* indexLabel,
...
@property(nonatomic, copy) void (^assetCellDidLayoutSubviewsBlock)(TZAssetCell* cell,
                                                                   UIImageView* imageView,
                                                                   UIImageView* selectImageView,
                                                                   UILabel* indexLabel,
                                                                   UIView* bottomView,
...
@property(nonatomic, copy) void (^photoPickerPageDidRefreshStateBlock)(UICollectionView* collectionView,
                                                                       UIView* bottomToolBar,
                                                                       UIButton* previewButton,
                                                                       UIButton* originalPhotoButton,
                                                                       UILabel* originalPhotoLabel,
...
@property(nonatomic, copy) void (^photoPreviewPageDidRefreshStateBlock)(UICollectionView* collectionView,
                                                                        UIView* naviBar,
                                                                        UIButton* backButton,
                                                                        UIButton* selectButton,
                                                                        UILabel* indexLabel,
...
/// Icon theme color, default is green color like wechat, the value is r:31 g:185 b:34. Currently only support image selection
/// icon when showSelectedIndex is YES. If you need it, please set it as soon as possible icon主题色，默认是微信的绿色，值是r:31
/// g:185 b:34。目前仅支持showSelectedIndex为YES时的图片选中icon。如需要，请尽早设置它。
...
@property(nonatomic, copy) void (^didFinishPickingPhotosWithInfosHandle)
    (NSArray<UIImage*>* photos, NSArray* assets, BOOL isSelectOriginalPhoto, NSArray<NSDictionary*>* infos);
@property(nonatomic, copy) void (^imagePickerControllerDidCancelHandle)(void);
@property(nonatomic, copy) void (^didFinishPickingVideoHandle)(UIImage* coverImage, PHAsset* asset, AVMutableComposition* cmpo);
